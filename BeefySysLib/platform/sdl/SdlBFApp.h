...
public:
	...
	virtual void*			GetUnderlying() override { NOT_IMPL_WARN; return mSDLWindow; }
	...
	virtual void			Resize(int x, int y, int width, int height, ShowKind showKind) override { NOT_IMPL_WARN; }
